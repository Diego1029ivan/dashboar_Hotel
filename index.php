...
<body id="page-top">
<?php $reserva = ($data_reserv) ?>
    <!-- Page Wrapper -->
    <div id="wrapper">

        <?php include './componentes/modulo.php'; ?>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Desarollo
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Cuadros de Ganancias</h6>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <a class="dropdown-item" id="btn<?php echo $arraySinDuplicados[$i]?>" href="#"><?php echo $arraySinDuplicados[$i] ?></a>
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                        ...
                                        <canvas id="myAreaReserva<?php echo $arraySinDuplicados[0]?>" class="active"></canvas>
                                        <?php for ($j=1; $j < count($arraySinDuplicados) ; $j++) { ?>
                                            <canvas id="myAreaReserva<?php echo $arraySinDuplicados[$j]?>"></canvas>
                                            <?php } ?> 
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Cuadros de Personas</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                        <canvas id="myAreaPersona" class="active"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Hoteles UNSM 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="js/areaReservas.js" type="text/javascript"></script>
    <script src="js/areaHoteles.js" type="text/javascript"></script>
    <script src="js/areaPersona.js" type="text/javascript"></script>
